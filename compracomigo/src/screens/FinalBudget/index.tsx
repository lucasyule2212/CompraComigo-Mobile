...
const FinalBudget: React.FC<FinalProps> = ({ navigation }: FinalProps) => {
  ...
  const { carrinhoEconomico, setCarrinhoEconomico } = useCarrinhoEconomicoStore(
    (state) => state
  );
  ...
  return (
    ...
    >
      ...
      <Flex
        ...
        pt={6}
      >
        {carrinhoEconomico?.valorTotalEconomia ? (
          <Flex align="center">
          ...
          <Flex align="center">
            <Heading
              ...
              p={6}
            >
              Você já pegou todos os itens mais baratos disponíveis!
            </Heading>
            <MainButton
              text="Até a próxima!"
              width={300}
